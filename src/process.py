...
def generate_heatmap(coco_json_path):
    """Generate and save a heatmap based on the bounding boxes in the COCO annotations."""
    ...
    output_path = os.path.join(output_dir, 'bounding_box_heatmap.png')

    # Save the heatmap using Matplotlib
