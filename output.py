...
# #     [70, 0],     # blue line
# #     [30, 20.5],  # far dot
# #     [30, 48.75]  # center edge of near face off circle
# # ], dtype='float32')
...
# #     [354, 432],  # Pixel coordinates for point 1
# #     [306, 467],  # Pixel coordinates for point 2
# #     [1366, 579], # Pixel coordinates for point 3
# #     [1427, 378],  # Pixel coordinates for point 4
# #     [826, 382],
# #     [1112, 474]
# # ], dtype='float32')
...
# # Function to get coordinates input from the user
# def get_coordinates_input(prompt):
#     coords_input = input(prompt)
#     coords_list = coords_input.split(",")  # Split input by commas
#     coords = [float(coord.strip()) for coord in coords_list]  # Convert strings to floats
#     return np.array(coords).reshape(-1, 1, 2)  # Reshape for homography input

# # Step 1: Get the 6 pixel coordinates as text input
# print("Enter the 6 pixel coordinates (x1, y1, x2, y2, ..., x6, y6) separated by commas:")
# pixel_coords = get_coordinates_input("Pixel coordinates: ")

# # Step 2: Get the 6 real-world coordinates (in feet) as text input
# print("Enter the 6 real-world coordinates in feet (x1, y1, x2, y2, ..., x6, y6) separated by commas:")
# real_coords = get_coordinates_input("Real-world coordinates: ")

# # Flatten the real_coords to 2D (6, 2) for the homography function
# real_coords_flat = real_coords.reshape(-1, 2)
...
# # Step 10: Save the image with the circle drawn
# output_image_path = '/content/final_image_with_bbox_and_circle.jpg'  # Path to save the image
# cv2.imwrite(output_image_path, blank_image)

# # Step 11: Show the final image with the circle and bounding box
# final_image_rgb = cv2.cvtColor(blank_image, cv2.COLOR_BGR2RGB)
# plt.imshow(final_image_rgb)
# plt.axis('off')  # Turn off axis for clean display
# plt.show()
